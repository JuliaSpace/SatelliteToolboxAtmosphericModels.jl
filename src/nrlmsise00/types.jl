...
- `plg::SMatrix{8, 4, T, 32}`: Unnormalized associated Legendre functions up to degree 7
    and order 3, where the element `[n + 1, m + 1]` holds the function of degree `n` and
    order `m` [-].

...
const _JR1971_CONSTANTS = (;
    ...
    αi = (N₂ = 0, O₂ = 0, O = 0, Ar = 0, He = -0.38, H = 0),

    # == Constituent density * M₀ / ρ_₁₀₀ / Av =============================================

    μi = (
        N₂ = 0.78110, O₂ = 0.161778, O = 0.095544, Ar = 0.0093432, He = 0.61471e-5, H = 0
    ),
    ...
    Ca = (-89284375.0, 3542400.0, -52687.5, 340.5, -0.8),

    la = (0.1031445e+5, 0.2341230e+1, 0.1579202e-2, -0.1252487e-5, 0.2462708e-9),
    ...
    β = (-52864482.17910969, -16632.50847336828, -1.308252378125, 0, 0, 0),

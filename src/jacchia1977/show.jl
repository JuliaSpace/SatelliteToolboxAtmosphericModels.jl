## Description #############################################################################
#
# Function to show the results of the Jacchia 1977 atmospheric model.
#
############################################################################################

function show(io::IO, out::Jacchia1977Output)
...
function show(io::IO, mime::MIME"text/plain", out::Jacchia1977Output)
    # Check for color support in the `io`.
    color = get(io, :color, false)
    b = color ? _B : ""
    d = color ? _D : ""
    ...
    println(io, "Jacchia 1977 Atmospheric Model Result:")

...
#     model. INPE, São José dos Campos, BR. The files ja77_stat.dat and ja77_dynm.dat were
#     generated by the test program available with the reference implementation in:
#
...
@testset "Errors" begin
    @test_throws ArgumentError AtmosphericModels.jacchia1977(now(), 0, 0, 89.9e3, 100, 100, 3)
    @test_throws ArgumentError AtmosphericModels.jacchia1977(now(), 0, 0, 2000.1e3, 100, 100, 3)
end
